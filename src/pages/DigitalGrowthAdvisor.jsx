    ...
    <main id="main-content" className="pt-16">
      ...
      <section className="border-y border-slate-800 bg-slate-900/50 px-5 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-5 max-w-3xl text-lg text-slate-300">Phone. Email. Face-to-face. Networking. Social. A combination. There is no single required NTA selling style.</p>
