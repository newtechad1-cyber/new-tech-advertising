...
import { Sparkles, CheckCircle2, AlertCircle, BarChart3, Eye, Zap } from 'lucide-react';
...
export default function AdminSchoolAIDashboard() {
  ...
  const mockJobs = [
    { id: 1, job_type: 'generate_story', source: 'Robotics Submission #1204', status: 'completed', moderation_status: 'approved', created: '2 hours ago', generated_title: 'Robotics Team Prepares for Regional Competition' },
    { id: 2, job_type: 'generate_captions', source: 'Football Game #1203', status: 'completed', moderation_status: 'approved', created: '4 hours ago', generated_title: '3 caption options' },
    { id: 3, job_type: 'generate_video_script', source: 'Football Game #1203', status: 'completed', moderation_status: 'approved', created: '3 hours ago', generated_title: 'Voiceover script generated' },
    { id: 4, job_type: 'generate_story', source: 'Choir Concert #1202', status: 'completed', moderation_status: 'pending_review', created: '45 minutes ago', generated_title: 'Spring Concert Highlights Excellence' },
    { id: 5, job_type: 'generate_headlines', source: 'STEM Showcase #1201', status: 'completed', moderation_status: 'pending_review', created: '30 minutes ago', generated_title: '5 headline options' },
  ];

  const mockTemplates = [
    { id: 1, name: 'Student Story Generator', prompt_type: 'story_generator', usage: 342, is_active: true },
    { id: 2, name: 'Yearbook Caption Generator', prompt_type: 'caption_generator', usage: 218, is_active: true },
    { id: 3, name: 'Video Highlight Script', prompt_type: 'video_script_generator', usage: 156, is_active: true },
    { id: 4, name: 'Headline Generator', prompt_type: 'headline_generator', usage: 298, is_active: true },
    { id: 5, name: 'Interview Questions', prompt_type: 'interview_question_generator', usage: 124, is_active: true },
    { id: 6, name: 'Story Rewriter', prompt_type: 'story_rewriter', usage: 87, is_active: true },
    { id: 7, name: 'Event Summary Generator', prompt_type: 'event_summary_generator', usage: 42, is_active: true },
    { id: 8, name: 'Yearbook Blurb Generator', prompt_type: 'yearbook_blurb_generator', usage: 31, is_active: true },
  ];
              ...
              return (
                <div key={idx} className={`rounded-lg border border-gray-200 bg-gradient-to-br ${stat.color} p-6 hover:shadow-md transition-shadow`}>
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span className="text-xs font-semibold text-gray-600 bg-white px-2 py-1 rounded">{stat.trend}</span>
                  </div>
            ...
            <div className="flex border-b border-gray-200">
              {[
                ...
                <button
                  ...
                  className={`px-6 py-4 font-semibold flex items-center gap-2 ${activeTab === tab.id ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-700 hover:text-gray-900'}`}
                >
                  {tab.icon} {tab.label}
                </button>
              ))}
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <span className="text-sm font-bold text-gray-900 uppercase">{job.job_type.replace(/_/g, ' ')}</span>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded">
                <p className="text-sm text-blue-900">
                  <strong>8 templates ready:</strong> Optimized prompt templates that guide AI generation while keeping content school-safe.
                </p>
              </div>
