...
import {
  CheckCircle, AlertTriangle, Zap, Shield, ArrowRight,
  Search, Smartphone, MousePointer, ChevronRight, MapPin
} from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white border-2 border-violet-200 rounded-3xl p-10 text-center shadow-sm">
            ...
            <p className="text-slate-600 leading-relaxed mb-4 max-w-2xl mx-auto">
              A great website is just the starting point. Local businesses in Mason City are using social media to drive consistent traffic, stay top-of-mind with customers, and turn their online presence into a steady stream of new leads.
            </p>
