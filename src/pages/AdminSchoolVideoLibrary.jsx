...
import { Search, Grid, List, Eye, Share2, Trash2, MoreVertical } from 'lucide-react';
...
export default function AdminSchoolVideoLibrary() {
  ...
  const videos = [
    { id: 1, title: 'Regional Basketball Tournament', thumbnail: '🏀', category: 'Sports', date: 'Mar 8, 2026', duration: '8:42', views: 342, visibility: 'public' },
    { id: 2, title: 'Science Fair Winners', thumbnail: '🔬', category: 'Academics', date: 'Mar 7, 2026', duration: '6:15', views: 156, visibility: 'public' },
    { id: 3, title: 'Spring Concert Highlights', thumbnail: '🎵', category: 'Arts', date: 'Mar 6, 2026', duration: '5:30', views: 289, visibility: 'public' },
    { id: 4, title: 'Robotics Competition Finals', thumbnail: '🤖', category: 'STEM', date: 'Mar 5, 2026', duration: '12:08', views: 421, visibility: 'public' },
    { id: 5, title: 'Drama Club Production', thumbnail: '🎭', category: 'Arts', date: 'Mar 4, 2026', duration: '9:45', views: 198, visibility: 'draft' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
          <div className="bg-white rounded-lg border border-gray-200 p-4 mb-6 flex flex-col sm:flex-row gap-4 items-center justify-between">
            <div className="flex-1 relative max-w-xs">
              ...
              <input type="text" placeholder="Search videos..." className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 text-sm" />
            </div>
                ...
                <div key={video.id} className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${video.visibility === 'public' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}>
                ...
                <tbody className="divide-y divide-gray-200">
                  {videos.map((video) => (
                    <tr key={video.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex gap-2">
                          <Button variant="ghost" size="sm" className="text-blue-600"><Eye className="h-4 w-4" /></Button>
                          <Button variant="ghost" size="sm" className="text-gray-600"><Share2 className="h-4 w-4" /></Button>
