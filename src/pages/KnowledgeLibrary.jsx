          ...
          <div className="max-w-5xl mx-auto flex flex-col gap-16">
            ...
            <div className="flex flex-col md:flex-row gap-10 items-center">
              <div className="flex-1">
                ...
                <h2 className="text-3xl font-black text-white mb-4">
                  {businessesThatLastKeepLearningArticle.title}
                </h2>
                <p className="text-slate-400 leading-relaxed mb-6">
                  {businessesThatLastKeepLearningArticle.searchDescription}
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to={`/knowledge/articles/${businessesThatLastKeepLearningArticle.slug}`} className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold px-6 py-3 rounded-xl transition-colors text-center">
                    Read the Article
                  </Link>
                </div>
              </div>
