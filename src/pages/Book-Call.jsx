...
export default function BookCall() {
  ...
  const seoHead = (
    <SEOHead
      title="Book a Strategy Call | New Tech Advertising"
      description="Book a practical strategy call with New Tech Advertising to discuss your business goals, marketing needs, and next useful step."
    />
  );
