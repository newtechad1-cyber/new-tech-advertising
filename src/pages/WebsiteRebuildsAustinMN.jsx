...
export default function WebsiteRebuildsAustinMN() {
  ...
  useEffect(() => {
    document.title = 'Website Rebuild Services in Austin MN | NTA';
    let meta = document.querySelector('meta[name="description"]');
    if (!meta) { meta = document.createElement('meta'); meta.name = 'description'; document.head.appendChild(meta); }
    meta.setAttribute('content', 'Need a better website in Austin, MN? We rebuild websites for speed, SEO, and conversions. Get your free audit today.');
  }, []);
