    ...
    <div className="min-h-screen bg-slate-950 font-sans text-slate-200">
      ...
      <main className="pt-24 pb-20">
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          {/* Lesson Content */}
          <article className="prose prose-invert prose-lg prose-emerald max-w-none prose-headings:text-white prose-p:text-slate-300 prose-p:leading-relaxed prose-a:text-emerald-400 hover:prose-a:text-emerald-300 prose-strong:text-white prose-ul:text-slate-300">
