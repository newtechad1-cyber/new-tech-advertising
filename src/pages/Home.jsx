      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-3 flex-shrink-0">
            ...
            <a href="https://calendar.app.google/p6ieYanvwhixXxZ67" target="_blank" rel="noopener noreferrer" className="border border-white text-white px-4 py-2 rounded font-semibold text-sm hover:bg-blue-500 transition">
              Book a Demo
            </a>
          </div>
        </div>
