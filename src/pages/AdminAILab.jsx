    ...
    <AdminShell schoolSlug={schoolSlug}>
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold flex items-center gap-2 mb-2">
          <Zap className="h-8 w-8 text-purple-600" /> AI Content Lab
        </h1>
        <p className="text-gray-600">AI assists your content team. All outputs are reviewed and approved by staff before use.</p>
      </div>
      ...
      {activeTab === 'dashboard' && (
        <div className="space-y-8">
          ...
          <div className="bg-gradient-to-r from-purple-50 via-blue-50 to-purple-50 border-2 border-purple-200 rounded-2xl p-8">
            ...
            <p className="text-gray-700 mb-6">Request AI assistance for faster content creation. Review, edit, and approve every piece before it goes live.</p>
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div className="bg-white rounded-lg p-4 border border-purple-100">
                <p className="font-bold text-purple-600 mb-2">💡 Smart Generation</p>
                <p className="text-gray-700 text-xs">Headlines, captions, scripts, and story ideas created in seconds</p>
              </div>
              <div className="bg-white rounded-lg p-4 border border-purple-100">
                <p className="font-bold text-purple-600 mb-2">👁️ Review & Edit</p>
                <p className="text-gray-700 text-xs">Every AI draft is reviewed by a staff member before use</p>
              </div>
              <div className="bg-white rounded-lg p-4 border border-purple-100">
                <p className="font-bold text-purple-600 mb-2">🔒 School-Safe</p>
                <p className="text-gray-700 text-xs">AI screening helps flag anything that needs human review</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-lg font-bold mb-2">Recent AI Requests</h3>
            <p className="text-gray-600 text-sm mb-6">New content generated by AI. Click on any job to review and decide what to do next.</p>
