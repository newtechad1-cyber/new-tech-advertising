...
const PROBLEMS = [
  ...
  { icon: Search, text: 'Weak SEO structure limiting visibility in Albert Lea searches' },
...
const SOLUTIONS = [
  { title: 'Built for Local Search Visibility', desc: 'Every page is structured with Albert Lea-focused keywords, proper heading hierarchy, and semantic markup that helps your business show up when local customers search.' },
  { title: 'Optimized for Mobile Users', desc: 'Most local searches happen on phones. We build mobile-first so every Albert Lea visitor gets a fast, smooth experience regardless of device.' },
  { title: 'Designed to Convert Visitors Into Calls', desc: 'Strategic calls-to-action, trust signals, and persuasive messaging placed exactly where Albert Lea customers need them to take action.' },
...
const PROCESS_STEPS = [
  { num: '01', title: 'Audit', desc: 'We analyze your current site — speed, local SEO gaps, conversion issues, ADA risks, and competitive positioning in Albert Lea.', color: 'bg-blue-600' },
  { num: '02', title: 'Rebuild', desc: 'Modern structure, locally optimized content, and conversion-focused design built from the ground up for Albert Lea businesses.', color: 'bg-violet-600' },
  { num: '03', title: 'Launch', desc: 'Your new site goes live fully optimized — fast, indexed, and ready to capture leads from Albert Lea and surrounding areas immediately.', color: 'bg-emerald-600' },
...
const FAQS = [
  { q: 'Do you work with businesses in Albert Lea, MN?', a: 'Yes. We work directly with small and local businesses in Albert Lea and throughout southern Minnesota. We understand the local market and build websites designed to perform in this region.' },
  ...
  { q: 'Will this help me rank better in local searches?', a: 'Yes. Every rebuild includes foundational local SEO — keyword-targeted pages, proper site structure, and location-relevant content that helps Albert Lea customers find you on Google.' },
  ...
  { q: 'Do you work with small businesses?', a: "That's our specialty. We've built our entire system around the needs of small and local businesses in Albert Lea, Mason City, Rochester, Austin, and surrounding communities." },
];
...
const TRUST_ITEMS = [
  { icon: MapPin, text: 'Serving Albert Lea and surrounding southern Minnesota communities' },
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white pt-24 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-5">
            ...
            <span className="text-blue-300 text-sm font-semibold uppercase tracking-widest">Albert Lea, Minnesota</span>
          </div>
          <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight mb-6">
            Website Rebuild Services in Albert Lea, MN
          </h1>
          <p className="text-lg sm:text-xl text-slate-300 max-w-3xl mx-auto mb-10 leading-relaxed">
            We help businesses in Albert Lea turn outdated websites into lead-generating systems with modern design, stronger SEO structure, and faster performance.
          </p>
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">Most Albert Lea Business Websites Are Losing Customers</h2>
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">
              Many small businesses in Albert Lea rely on their website, but most are not built to generate leads consistently. If your site has any of these issues, it may be costing you business every day.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">Website Rebuilds Designed for Albert Lea Businesses</h2>
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-red-950/40 border border-red-800/50 rounded-2xl p-8">
              ...
              <ul className="space-y-4">
                {['Outdated local business site', 'Slow load times (5–8 seconds)', 'Weak visibility in Albert Lea searches', 'Confusing layout and navigation', 'No lead capture system', 'Buried on page 3+ of Google'].map(item => (
            ...
            <div className="bg-emerald-950/40 border border-emerald-700/50 rounded-2xl p-8">
              ...
              <ul className="space-y-4">
                {['Modern, professional website', 'Lightning fast (under 2 seconds)', 'Stronger local search presence in Albert Lea', 'Clear messaging and easy navigation', 'Automated lead capture system', 'Ranking for local keywords'].map(item => (
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-600 text-lg max-w-xl mx-auto">
              We work with Albert Lea-area business owners to improve online visibility and turn websites into stronger sales tools.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-600 text-lg mb-12 max-w-xl mx-auto">
            We're not a generalist agency. We're built specifically for small and local businesses in Albert Lea, southern Minnesota, and surrounding communities.
          </p>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="bg-gradient-to-br from-blue-50 to-slate-50 border-2 border-blue-200 rounded-3xl p-10 text-center shadow-lg">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Get a Free Website Audit in Albert Lea</h2>
            <p className="text-slate-600 mb-8 leading-relaxed max-w-xl mx-auto">
              If your Albert Lea business website is outdated, underperforming, or not bringing in leads, we'll show you exactly what to fix and where the biggest opportunities are.
            </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white border-2 border-violet-200 rounded-3xl p-10 text-center shadow-sm">
            ...
            <p className="text-slate-600 leading-relaxed mb-4 max-w-2xl mx-auto">
              A great website is just the starting point. Local businesses in Albert Lea are using social media to drive consistent traffic, stay top-of-mind with customers, and turn their online presence into a steady stream of new leads.
            </p>
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-extrabold mb-6 leading-tight">
            Need More Leads From Your Website in Albert Lea?
          </h2>
