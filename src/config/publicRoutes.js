...
// legacy import removed: AiSocialMediaSmallBusiness from '@/pages/AiSocialMediaSmallBusiness';
...
// legacy import removed: ContractorMarketingNorthIowa from '@/pages/ContractorMarketingNorthIowa';
...
// legacy import removed: HvacIndustry from '@/pages/HvacIndustry';
...
// legacy import removed: LocalBusinessMarketing from '@/pages/LocalBusinessMarketing';
...
// legacy import removed: RestaurantSocialMedia from '@/pages/RestaurantSocialMedia';
...
// legacy import removed: SocialMediaContentSystem from '@/pages/SocialMediaContentSystem';
// legacy import removed: SocialMediaManagement from '@/pages/SocialMediaManagement';
// legacy import removed: SocialMediaMasonCity from '@/pages/SocialMediaMasonCity';
// legacy import removed: SocialMediaRochesterMN from '@/pages/SocialMediaRochesterMN';
// legacy import removed: SocialMediaAustinMN from '@/pages/SocialMediaAustinMN';
// legacy import removed: SocialMediaAlbertLeaMN from '@/pages/SocialMediaAlbertLeaMN';
import SchoolTVDealRoom from '@/pages/SchoolTVDealRoom';
import SchoolTVDemo from '@/pages/SchoolTVDemo';
import Start from '@/pages/Start';
// legacy import removed: SmallBusinessMarketingNorthIowa from '@/pages/SmallBusinessMarketingNorthIowa';
...
// legacy import removed: WebsiteRebuildService from '@/pages/WebsiteRebuildService';
// legacy import removed: WebsiteRebuildsAlbertLeaMN from '@/pages/WebsiteRebuildsAlbertLeaMN';
// legacy import removed: WebsiteRebuildsAustinMN from '@/pages/WebsiteRebuildsAustinMN';
// legacy import removed: WebsiteRebuildsMasonCity from '@/pages/WebsiteRebuildsMasonCity';
// legacy import removed: WebsiteRebuildsRochesterMN from '@/pages/WebsiteRebuildsRochesterMN';
...
export const PUBLIC_ROUTE_ALIASES = [
  ...
  alias('/local-business-marketing', AiMarketingPlatform),
  ...
  alias('/services/website-rebuilds', AiWebsites),
  alias('/website-rebuilds', AiWebsites),
  alias('/services/social-media-management', AiSocialMedia),
  alias('/social-media-content-system', AiSocialMedia),
  alias('/ai-seo', AiSeo),
  ...
  alias('/seo-pages-for-local-businesses', AiSeo),
  alias('/seasonal-campaigns', LocalLeadSystems),
  alias('/hvac-marketing-north-iowa', HVACMarketingNorthIowa),
  alias('/hvac-industry', HVACMarketingNorthIowa),
  alias('/contractor-marketing-north-iowa', IndustriesHub),
  alias('/small-business-marketing-north-iowa', IndustriesHub),
  alias('/small-businesses-nationwide', SmallBusinessesNationwide),
  alias('/social-media/mason-city-ia', AiSocialMedia),
  alias('/social-media/rochester-mn', AiSocialMedia),
  alias('/social-media/austin-mn', AiSocialMedia),
  alias('/social-media/albert-lea-mn', AiSocialMedia),
  alias('/website-rebuilds/mason-city-ia', AiWebsites),
  alias('/website-rebuilds/rochester-mn', AiWebsites),
  alias('/website-rebuilds/austin-mn', AiWebsites),
  alias('/website-rebuilds/albert-lea-mn', AiWebsites),
