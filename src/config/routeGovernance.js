...
export const PAGE_KEY_PREFIX_RULES = [
  ...
  { prefix: 'SiteMap',               access: 'admin_only' },
...
export const ROUTE_OVERRIDES = {
  ...
  '/start':                      'public',
  '/get-started':                 'noindex',
  '/growth-system':               'public',
  '/local-business-marketing':    'public',
  '/industries':                  'public',
  '/ai-marketing-platform':       'public',
  '/ai-social-media-small-business': 'public',
  '/restaurant-social-media':     'public',
  '/streaming-tv-advertising':    'public',
