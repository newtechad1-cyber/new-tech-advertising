...
const PARTS = [
  { num: '01', title: 'Foundation', desc: "Understand what Cattleman's Dining already has in place—website, menu, Google presence, customer access points, existing systems, and how people currently find and interact with the restaurant." },
  { num: '02', title: 'Digital Growth Office', desc: "Create a practical place where Pete, Janine, the restaurant's team, and NTA can bring questions, ideas, observations, customer feedback, and ongoing work together." },
  ...
  { num: '04', title: 'Audience & Growth', desc: "Instead of trying to market everything at once, identify the part of the restaurant that deserves attention and build the appropriate website, Google, content, video, social, customer communication, or other marketing around that priority." },
  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-500/25 bg-blue-500/10 text-blue-300 text-xs font-semibold uppercase tracking-wider mb-8">
        <Map className="w-3.5 h-3.5" /> The Cattleman's Dining Growth Roadmap
      </div>
