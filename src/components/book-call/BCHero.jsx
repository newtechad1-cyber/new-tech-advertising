...
export default function BCHero() {
  ...
  const handleClick = () => {
    console.log('[BCHero] Booking CTA clicked');
    console.log('[BCHero] Target URL:', BOOKING_URL);
    setOpened(true);
    console.log('[BCHero] Acknowledgement state: shown');
  };

  console.log('[BCHero] Booking CTA rendered');
  ...
  return (
    <section className="relative bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 py-24 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="text-slate-500 text-sm mt-6 block">
