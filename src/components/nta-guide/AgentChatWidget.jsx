            ...
            {authStep === 'connect' ? (
                <div className="flex-1 p-6 flex flex-col bg-white overflow-y-auto">
                    <div className="text-center mb-5">
                        <div className="w-14 h-14 bg-black rounded-full flex items-center justify-center mx-auto mb-4 overflow-hidden border border-slate-200 shadow-sm">
                            <img src="https://media.base44.com/images/public/691f41a18de4a7f498c8f884/04e19b127_favicon_64x64.png" alt="Bot" className="w-full h-full object-cover" />
                        </div>
                        <p className="text-[15px] text-slate-700 leading-relaxed">
                            Hi! I'm your AI marketing advisor. I can help with pricing, strategy, and growing your business online.
                        </p>
                    </div>
                    ...
                    <div className="mt-auto space-y-3">
                        <p className="text-center text-xs text-slate-500">Sign in with Google to start a free conversation</p>
                        <Button 
                        ...
                        <p className="text-center text-[11px] text-slate-400">Free • No credit card • Takes 2 seconds</p>
                    </div>
                </div>
            ) : authStep === 'chat' ? (
                <>
