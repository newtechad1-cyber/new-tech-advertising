...
const NAV_LINKS = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Restaurant Solutions', href: '/restaurants', desc: 'Build a stronger restaurant with your whole team' },
      { label: 'HVAC', href: '/hvac-marketing-north-iowa', desc: 'Practical growth ideas for HVAC businesses' },
      { label: 'Local Lead Systems', href: '/local-lead-systems', desc: 'Connect visibility, response and follow-up' },
      { label: 'Streaming TV', href: '/streaming-tv-advertising', desc: 'Understand where streaming TV may fit' },
      { label: 'Back Office', href: '/back-office-solutions', desc: 'Connect the work happening behind the scenes' },
    ],
  },
  {
    label: 'Opportunity',
