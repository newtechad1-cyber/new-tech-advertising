...
const NAV_LINKS = [
  { label: 'Home', href: '/' },
  {
    ...
    children: [
      ...
      { label: 'Gap Audit', href: '/free-audit', desc: 'A practical look at your business' },
    ],
  },
  {
    label: 'Learn',
  ...
  },
  {
    ...
    href: '/services',
    children: [
      { label: 'AI for Small Business', href: '/ai-marketing-platform', desc: 'AI built for small business growth' },
      { label: 'Websites', href: '/ai-websites', desc: 'Websites that work like salespeople' },
      { label: 'Marketing', href: '/ai-social-media', desc: 'Social media and content systems' },
      { label: 'SEO', href: '/ai-seo', desc: 'Local search and AI visibility' },
      { label: 'Industry Solutions', href: '/industries', desc: 'Built for your industry' },
      { label: 'Restaurant Solutions', href: '/restaurants', desc: 'Marketing built for restaurants' },
      { label: 'HVAC', href: '/hvac-marketing-north-iowa', desc: 'Marketing built for HVAC' },
      { label: 'Local Lead Systems', href: '/local-lead-systems', desc: 'Lead systems for local businesses' },
      { label: 'Streaming TV', href: '/streaming-tv-advertising', desc: 'Streaming TV advertising' },
      { label: 'Back Office', href: '/back-office-solutions', desc: 'Back office solutions' },
    ],
  },
  {
    label: 'Opportunity',
    ...
    children: [
      ...
      { label: 'Regional Account Manager', href: '/regional-account-manager', desc: 'Local relationships, national support' },
      { label: 'Learn. Earn. Build.', href: '/join-nta', desc: 'Build a future with NTA' },
      { label: 'Opportunity Overview', href: '/community-partner', desc: 'Partner and grow with NTA' },
    ],
  },
  {
    label: 'About',
    href: '/why-nta',
    children: [
      { label: 'About Rick', href: '/our-story', desc: 'The story behind NTA' },
      { label: 'Why NTA', href: '/why-nta', desc: 'Why this work matters' },
      { label: 'Contact', href: '/contact', desc: 'Call, text, email, or a conversation' },
    ],
  },
];
