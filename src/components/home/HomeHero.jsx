      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-6">
          <span className="inline-flex items-center gap-2 bg-violet-600/20 border border-violet-500/30 text-violet-300 text-sm font-medium px-4 py-1.5 rounded-full">
            ...
            AI Marketing Platform Built for Small Business
          </span>
        </div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-cyan-400">
              Yourself — or Let Us Do It
            </span>
          </h1>
          <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-8 leading-relaxed">
            New Tech Advertising gives small businesses an AI-powered content engine that generates social posts, videos, and campaigns — automatically. DIY or fully managed.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
            ...
            >
              <Play className="w-4 h-4 fill-white" /> Book Strategy Call
            </Link>
          </div>

          <Link
            to={createPageUrl('Free-Audit')}
            className="text-slate-400 hover:text-violet-300 text-sm underline underline-offset-4 transition-colors"
          >
