...
const ADMIN_NAV_STRUCTURE = [
  ...
  },
  {
    ...
    icon: '🏫',
    items: [
      { label: 'School Dashboard', page: 'AdminSchoolDashboard' },
      { label: 'Submissions', page: 'AdminSchoolSubmissions' },
      { label: 'Projects', page: 'AdminSchoolProjects' },
      { label: 'Story Library', page: 'AdminSchoolStoryLibrary' },
      { label: 'Video Library', page: 'AdminSchoolVideoLibrary' },
      { label: 'Yearbook', page: 'AdminSchoolYearbook' },
      { label: 'Events', page: 'AdminSchoolEvents' },
      { label: 'Spotlights', page: 'AdminSchoolSpotlights' },
      { label: 'Render Queue', page: 'AdminSchoolRenderQueue' },
      { label: 'AI Dashboard', page: 'AdminSchoolAIDashboard' },
      { label: 'Settings', page: 'AdminSchoolSettings' },
    ],
  },
  {
    id: 'sales-revenue',
