export const lesson14 = {
  id: 14,
  slug: "use-the-model-that-gets-the-job-done",
...
`,
  ...
  relatedVideos: [
    { label: "The Hidden Economics of AI", link: "/knowledge/videos" }
  ],
  relatedLessons: [
    { label: "AI Isn't Magic Either", link: "/knowledge/ai-foundations/ai-isnt-magic-either" },
  ...
  relatedModules: [
    ...
    { label: "The NTA Journal", link: "/journal" }
  ]
};
