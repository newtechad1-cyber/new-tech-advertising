export const lesson15 = {
  id: 15,
  slug: "ai-finally-taught-me-how-to-multitask",
  title: "AI Finally Taught Me How to Multitask",
  description: "AI did not make Rick’s brain multitask. It helped him carry less context while directing more ideas, projects, decisions, and work forward.",
  searchDescription: "AI did not make Rick’s brain multitask. It helped him carry less context while directing more ideas, projects, decisions, and work forward.",
  publishedDate: "2026-09-04",
  readingTime: "8–10 min read",
  level: "Beginner",
  takeaway: "AI does not make one person do everything. It helps a person capture, contextualize, direct, and return to several worthwhile streams of work without carrying every detail in their head.",
  content: `
