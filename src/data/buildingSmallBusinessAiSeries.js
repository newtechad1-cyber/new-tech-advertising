export const buildingSmallBusinessAiSeriesLessons = [
  {
    id: 1,
    slug: "the-problems-we-learn-to-live-with",
    title: "The Problems We Learn to Live With",
    description: "Small-business owners often know what needs fixing, but for years many could not afford the people, time, or systems required to solve every problem. AI changes that equation.",
    searchTitle: "The Problems Small Businesses Learn to Live With",
    searchDescription: "Why small-business owners often live with known problems, and how AI changes the economics of adding capabilities once reserved for larger companies.",
    readingTime: "8–10 min read",
    level: "Beginner",
    publishedDate: "2026-08-18",
    modifiedDate: "2026-08-18",
    takeaway: "AI lets a small business build capabilities that once required a much larger company, making it practical to solve problems owners may have understood for years but could not afford to staff around.",
    content: `
...
`,
    relatedLessons: [
      { label: "What Building My Own Digital Growth Office Taught Me", link: "/knowledge/business-foundations/what-building-my-own-digital-growth-office-taught-me" },
      { label: "Start With the Work, Not the Tool", link: "/knowledge/ai-foundations/start-with-the-work-not-the-tool" }
    ],
    relatedModules: [
      { label: "Practical AI for Small Business", link: "/practical-ai-for-small-business" },
      { label: "NTA Journal", link: "/nta-journal" }
    ]
  },
  {
    id: 2,
    slug: "ai-gives-small-business-its-speed-back",
    title: "AI Gives Small Business Its Speed Back",
    description: "AI can give small companies some of the capabilities of large organizations without forcing them to inherit the layers, overhead, and slow decision-making that often come with size.",
    searchTitle: "How AI Gives Small Business Its Speed Back",
    searchDescription: "AI can give small businesses big-company capability while preserving small-company speed, flexibility, and the ability to change quickly.",
    readingTime: "9–11 min read",
    level: "Beginner",
    publishedDate: "2026-08-18",
    modifiedDate: "2026-08-18",
    takeaway: "The opportunity is not simply to make a small business act like a big company. It is to gain useful big-company capabilities while keeping the speed and flexibility that make small companies different.",
    content: `
...
`,
    relatedLessons: [
      ...
      { label: "Automation Comes After Understanding", link: "/knowledge/ai-foundations/automation-comes-after-understanding" }
    ],
    relatedModules: [
      { label: "Practical AI for Small Business", link: "/practical-ai-for-small-business" },
      { label: "NTA Journal", link: "/nta-journal" }
...
`,
    relatedLessons: [
      ...
      { label: "You Can Do What I Do—But You Don't Have To", link: "/knowledge/ai-foundations/you-can-do-what-i-do-but-you-dont-have-to" }
    ],
    relatedModules: [
      { label: "Practical AI for Small Business", link: "/practical-ai-for-small-business" },
      { label: "NTA Journal", link: "/nta-journal" }
