...
import { lesson10 } from './aiFoundationsLesson10';

export const aiFoundationsLessons = [
  {
    id: 1,
    slug: "ai-isnt-magic-either",
    ...
    level: "Beginner",
    takeaway: "AI can help you think, create, organize, and accomplish more—but it still needs human experience, direction, and judgment. It is a powerful tool, not a magic answer.",
    content: `
...
`,
  ...
  },
  {
    ...
    readingTime: "9–10 min read",
    level: "Beginner",
    takeaway: "Don’t begin by asking which AI tool you should buy. Begin by identifying the work that needs to be understood, improved, or completed.",
    content: `
...
`,
    relatedPrompts: [
      { label: "AI Work and Friction Finder", link: "/knowledge/prompts" }
    ],
    relatedVideos: [
      { label: "Practical AI for Small Businesses", link: "/practical-ai-for-small-businesses" },
      { label: "Don’t Buy an AI Tool Until You Understand the Job", link: "/knowledge/videos" }
    ],
    relatedModules: [
