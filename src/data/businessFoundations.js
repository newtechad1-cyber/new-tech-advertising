...
If they help you build a better business, then everything I've learned over the past fifty years will have been worth passing on.
    ...
    relatedVideos: [
      { label: "Growth Systems vs Campaigns", link: "/growth-systems-vs-campaigns" }
    ],
    relatedModules: [
      { label: "NTA Operating System", link: "/operating-system" }
    ],
    nextLessonSlug: "how-businesses-really-grow"
  },
  {
    id: 2,
...
It doesn't replace them.
    ...
    relatedVideos: [
      { label: "Building Digital Trust", link: "/building-digital-trust" }
    ],
    relatedModules: [
      { label: "Growth Roadmap", link: "/growth-roadmap-generator" }
    ],
    nextLessonSlug: "marketing-isnt-magic"
  },
  {
    id: 3,
...
When your message, relationships, service, and follow-up work together, marketing becomes far more effective because it is supporting something solid instead of trying to compensate for something missing.
    ...
    relatedVideos: [
      { label: "Campaigns vs Authority", link: "/campaigns-vs-authority" }
    ],
    relatedModules: [
      { label: "Business Growth Conversation", link: "/growth-conversation" }
    ],
    nextLessonSlug: "every-system-produces-exactly-what-it-was-designed-to-produce"
  },
  {
    id: 4,
...
You don't have to answer all of them today. Sometimes the right question is more valuable than a quick answer.
    ...
    relatedVideos: [
      { label: "The Hidden Cost of Outdated Marketing", link: "/hidden-cost-of-outdated-marketing" }
    ],
    relatedModules: [
      { label: "NTA Business Score", link: "/business-score" }
    ],
    nextLessonSlug: "understanding-before-spending"
  },
  {
    id: 5,
...
Those questions have saved me from making poor decisions more than once. They may do the same for you.
    ...
    relatedVideos: [
      { label: "Digital Risks", link: "/digital-risks" }
    ],
    relatedModules: [
      { label: "AI Learning Conversation", link: "/learning-center" }
    ],
    nextLessonSlug: "ai-is-my-team-not-my-replacement"
  },
  {
    id: 6,
...
Those questions aren't really about technology. They're about possibility.
    ...
    relatedVideos: [
      { label: "The Role of AI in Local Marketing", link: "/role-of-ai-in-local-marketing" }
    ],
    relatedModules: [
      { label: "Community Intelligence", link: "/community-intelligence" }
    ],
    nextLessonSlug: "why-trust-comes-before-marketing"
  },
  {
    id: 7,
...
When you build a fortress of trust first, every marketing dollar you spend afterward becomes exponentially more effective.
    ...
    relatedVideos: [
      { label: "Reputation is Now a Growth Engine", link: "/reputation-is-now-a-growth-engine" }
    ],
    relatedModules: [
