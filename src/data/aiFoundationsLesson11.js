export const lesson11 = {
  id: 11,
  slug: "i-see-artificial-intelligence-differently",
  ...
  level: "Beginner",
  takeaway: "AI should begin with the human problem, the knowledge worth preserving, and the relationship worth strengthening. The technology serves the purpose—not the other way around.",
  content: `
...
“I do not want to start with an AI tool. Help me understand the larger picture first. Ask me who I am trying to serve, what problem I am solving, what already works, what knowledge needs to be preserved, what relationships could be affected, and what decisions must remain human.”
  `,
  relatedPrompts: [
    { label: "Human-Centered AI Discovery", link: "/knowledge/prompts" }
  ],
  relatedVideos: [
    { label: "AI Brought Me Out of Retirement", link: "/ai-brought-me-out-of-retirement" }
  ],
  relatedModules: [
    { label: "Why NTA", link: "/why-nta" },
    { label: "NTA AI Policy", link: "/ai-policy" }
  ],
  nextLessonSlug: null
};
