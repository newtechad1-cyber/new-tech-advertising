...
// HARDCODED — no env var override. These are the ONLY scopes requested.
...
Deno.serve(async (req) => {
  ...
  console.log(`[facebookOAuthStart] OAUTH_SCOPE_VERSION=2026-05-04-reduced-scopes scope=${SCOPE} scope_source=hardcoded`);
  ...
  await log(base44, {
    ...
    payload: JSON.stringify({ client_id, client_name, scope: SCOPE, nonce }),
  });
