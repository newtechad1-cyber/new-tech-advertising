...
| 0.7.0 | Authority & Discoverability | Released | `build/r0.7-authority-discoverability` | PR #16 (merged) | `v0.7.0` | 2026-07-06 | Viktor | Growth release. AI Crawl Optimization (llms.txt, ai-sitemap.json), 11 JSON-LD schema types, 8 topic clusters, TopicalAuthorityMap, Authority Dashboard (/admin/authority). CEO vision: "Do not build another feature until the Knowledge System becomes measurable." CEO approved. |
...
2026-07-06  R0.7.0 Authority & Discoverability ..... Released (v0.7.0)
...
| 0.7 | Authority & Discoverability (Released) |
